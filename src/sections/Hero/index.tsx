...
export default function Hero() {
  ...
  return (
    <div id="Hero" className=' h-screen lg:mx-20 xl:mx-20 xl:my-7 lg:my-7 group overflow-hidden'>
        ...
        <div className="grid grid-rows-2 lg:grid-cols-[40%_60%] xl:grid-cols-[40%_60%]  justify-center gap-5">
        <div className=" h-[20rem] flex flex-col justify-center w-full lg:mt-20 z-50 relative order-last  
        ...
        <div className="">
            <div className="w-full grid grid-rows-3 gap-2 max-h-[31rem] xl:max-h-[40rem] ">
                {herodata.map((data, index) => (
                    <Swiper className="h-full overflow-hidden" key={index}
                    mousewheel={true}
                    direction="vertical"
