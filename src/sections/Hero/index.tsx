...
export default function Hero() {
  return (
    <div
      id="Hero"
      className=" lg:mx-20 xl:mx-20 xl:my-7 lg:my-7 mb-16 group overflow-hidden "
    >
      ...
      <div className="flex flex-wrap lg:flex-nowrap xl:flex-nowrap lg:grid-cols-[40%_60%] xl:grid-cols-[40%_60%] justify-center gap-10 lg:gap-5 xl:lg:gap-5">
        <div className="w-full h-[20rem] flex flex-col justify-center lg:mt-20 z-50 relative order-last lg:order-first xl:order-first">
